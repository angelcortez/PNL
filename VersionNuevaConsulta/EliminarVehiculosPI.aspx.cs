...
{
    public partial class EliminarVehiculosPI : System.Web.UI.Page
    {
        ...
        public void EliminarVehiculo_Command(object sender, CommandEventArgs e)
        {
            ...
            PGJ.InsertarBitacora(Session["USUARIO"].ToString(), Session["IP_SERVER"].ToString(), Session["NOM_MAQUINA"].ToString(), "" + Session["PAGINA"], "Se elimino un Vehiculo de la Carpeta" + IdCarpeta.Text);
            ...
            gvVehiculos.DataSourceID = "dsCargarVehiculos";
