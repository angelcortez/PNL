...
{
    public partial class FormaInicioRac : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Panel2.Visible = true;
            lblMensajeSession.Text = Session["TipoDQ"].ToString();
        ...
        protected void cmdCompa_Click(object sender, EventArgs e)
        {
            ...
            string Sql = "Set DateFormat dmy exec InsertaRAC2 " + Session["IdUnidad"].ToString() + ",''," + "10" + "," + short.Parse(Session["IdUsuario"].ToString()) + "," + short.Parse(IdCarpetaInicio.Text) + "," + "0" + "," + short.Parse(Session["IdMunicipio"].ToString()) + "," + int.Parse(lblMensajeSession.Text);
        ...
        {
            string Sql = "Set DateFormat dmy exec InsertaRAC1 " + Session["IdUnidad"].ToString() + ",''," + "10" + "," + short.Parse(Session["IdUsuario"].ToString()) + "," + short.Parse(IdCarpetaInicio.Text) + "," + "1" + "," + short.Parse(Session["IdMunicipio"].ToString()) +","+ int.Parse(lblMensajeSession.Text);
        ...
        protected void cmdInforme_Click(object sender, EventArgs e)
        {
            ...
            //Panel1.Visible = true;
            Panel2.Visible = false;
            string Sql = "Set DateFormat dmy exec InsertaRAC1 " + Session["IdUnidad"].ToString() + ",''," + "10" + "," + short.Parse(Session["IdUsuario"].ToString()) + "," + short.Parse(IdCarpetaInicio.Text) + "," + "0" + "," + short.Parse(Session["IdMunicipio"].ToString()) + "," + int.Parse(lblMensajeSession.Text);
            //string Sql = "Set DateFormat dmy exec InsertaRAC " + "''," + "10" + "," + short.Parse(Session["IdUsuario"].ToString()) + "," + short.Parse(IdCarpetaInicio.Text) + "," + "0" + "," + short.Parse(Session["IdMunicipio"].ToString()) + "," + short.Parse(Session["IdUnidad"].ToString());
        ...
        protected void cmdIncompetencia_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("WDatoIncompetencia.aspx?&op=Agregar" + "&ID_ESTADO_RAC=" + 10);
            }
            else
            {
                Response.Redirect("LugarHechos.aspx?&op=Agregar" + "&ID_ESTADO_RAC=" + 10);
        ...
        protected void cmdDenunciaAnonima_Click(object sender, EventArgs e)
        {
