<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WReporte4.aspx.cs" Inherits="AtencionTemprana.WReporte4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%;">
     ...
     <tr>
        <td colspan="3">
                        ...
                        Text="Conteo de denuncias por municipio de hechos." Width="1089px"></asp:Label>
        </td>
     </tr>
     <tr>
    ...
    <br />
        ...
        <Columns>
            <asp:BoundField DataField="MUNICIPIO" HeaderText="MUNICIPIO DEL HECHO" ReadOnly="True" 
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="981px">
         ...
         <asp:ObjectDataSource ID="ObjectTabla" runat="server" 
             ...
             TypeName="AtencionTemprana.dsReportesTableAdapters.SP_ConteoMunicipioHechosTablaTableAdapter">
                    <SelectParameters>
