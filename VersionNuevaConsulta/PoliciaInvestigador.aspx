<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PoliciaInvestigador.aspx.cs" Inherits="AtencionTemprana.PoliciaInvestigador" %>
        ...
        <table style="width: 100%;" >
            <tr>
                <td>
                    ...
                    <br />
                    <br />
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="Black" style="font-size:20px"
                     Text="ORDENES ASIGNADAS"></asp:Label>
                </td>
            </tr>
            <tr>
