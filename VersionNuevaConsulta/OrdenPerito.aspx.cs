...
{
    public partial class OrdenPerito : System.Web.UI.Page
    {
        Data PGJ = new Data();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //}
                //else 
                    if (Request.QueryString["ID_CARPETA"] != null && Request.QueryString["ID_SP"] != null)
                {
                    Session["ID_CARPETA"] = Request.QueryString["ID_CARPETA"];
                    Session["ID_SP"] = Request.QueryString["ID_SP"];
                }
                ...
                if (Session["op"].ToString() == "Perito")
                {
                    CargarDocumentoPeritos(Session["IdDoc"].ToString());
                }


                if (Session["op"].ToString() == "FotoPerito")
                {
        ...
        private void CargarDocumentoPeritos(string ID_PDF)
        {
            byte[] bits;
            try
            {
        ...
        protected void CargarDatosCarpeta()
        {
            try
            {
               ...
               // PGJ.InsertaArbol(22, 20, "ANEXOS", "", "", IdUser);
                ...
                CargarDatosArbol("Perito", 20);
                 CargarDatosArbol("FotoPericiales", 21);
               // CargarDatosArbol("AnexosP", 22);
        ...
        protected void Image2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else if (Session["ID_PUESTO"].ToString() == "18")
            {
                Response.Redirect("Periciales.aspx");
            } 
        }
        ...
        {
            Response.Redirect("RedactarInformePericial.aspx");
        }
