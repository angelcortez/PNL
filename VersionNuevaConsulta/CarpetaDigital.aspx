<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CarpetaDigital.aspx.cs" Inherits="AtencionTemprana.CarpetaDigital" %>
   ...
   <table style="width: 100%;">
        <tr>
          ...
          <tr>
              ...
              <td>
                  <asp:Label ID="IdDigital" runat="server" Visible="False"></asp:Label>
              </td>
              <td align="right">
     ...
     <h2> 
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:DropDownList ID="ddlPlantilla" runat="server" Width="400px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
