...
{
    public partial class NUC : System.Web.UI.Page
    {
        Data PGJ = new Data();
        ...
        protected void ImgSi8_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (CnnPNL.State == 0)
            {
                lblEstatus.Text = "No hay Conexión con la Unidad Seleccionada. Intente más tarde";
            }
            else
            {
                lblEstatus.Text = "Conexion Exitosa";
            }
        ...
        {
            string Sql = "select ip_servidor from cat_unidad_servidor where id_undd=" + DDUnidades.SelectedValue;
        ...
        protected void CmdRemitir_Click(object sender, EventArgs e)
        {
            Panel2.Visible = false;
            Panel1.Visible = false;
            Panel3.Visible = false;
