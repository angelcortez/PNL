...
{
    public partial class DireccionServiciosPericiales : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["ID_SP"] != "")
                {
                    IdSP.Text = Request.QueryString["ID_SP"];
                }
                ...
                PGJ.CargaComboPe(ddlSERP, "CAT_DEPARTAMENTO_PERICIAL", "Id_DEPTO_PRCIAL", "DEPTO_PRCIAL");
                PGJ.CargaComboFiltradoPe(ddlMuni, "CAT_MUNICIPIO", "Id_MNCPIO", "MNCPIO", "ID_ESTDO = 28");
        ...
        protected void gvConsultarPI_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //ESTADO DE LA ORDEN
                if (e.Row.Cells[7].Text == "CUMPLIDA")
                {
                    e.Row.Cells[9].Text = "";
                }
            }
        ...
        protected void cmdAsignar_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in gvAsignarPI.Rows)
            {
                ...
                {
                    Session["ID_SP_TEMP"] = IdSP.Text;
                    Session["ID_USUARIO_TEMP"] = row.Cells[1].Text;
                    PGJ.AsignarSolicitud_Perito_TEMP(Convert.ToInt32(IdSP.Text), Convert.ToInt32(row.Cells[1].Text));

                    try
                    {
                        Session["ID_PLANTILLA"] = 103;
        ...
        public void ImageButton_Command(object sender, CommandEventArgs e)
        {
            ...
            //////Seleccionamos el ID del OFICIO DE ASIGNACION DEL PERITO para eliminarlo de la tabla  PG_
            ////PGJ.ConnectServer();
            ////SqlCommand comm = new SqlCommand("SELECT ID_OFICIO_SOLICITUD FROM PGJ_ORDEN_ASIGNADA_PI WHERE ID_ORDEN_PI = " + IdSP.Text + "AND ID_USUARIO = " + e.CommandArgument.ToString(), Data.CnnCentral);
            ////SqlDataReader dr = comm.ExecuteReader();
            ////if (dr.HasRows)
            ////{
            ////    while (dr.Read())
            ...
            PGJ.EliminarP_SolicitudAsignada(Convert.ToInt32(IdSP.Text), Convert.ToInt32(e.CommandArgument.ToString()));
            gvConsultarPI.DataSourceID = "dsVerPERITOS";
        ...
        protected void btnEnviada_Click(object sender, EventArgs e)
        {
            ...
            gvNuc.DataSourceID = "dsBuscarEstadoSolicitudP_Enviada";
            gvNuc.DataBind();
        ...
        protected void btnAsignada_Click(object sender, EventArgs e)
        {
            ...
            gvNuc.DataBind();
            Label5.Text = gvNuc.Rows.Count.ToString();
            lblBuscar.Visible = false;
            ddlBuscar.Visible = false;
            btnMostrar.Visible = true;
            Label5.Visible = true;
        ...
        protected void btnProceso_Click(object sender, EventArgs e)
        {
            ...
            gvNuc.DataBind();
            Label6.Text = gvNuc.Rows.Count.ToString();
            lblBuscar.Visible = false;
            ddlBuscar.Visible = false;
            btnMostrar.Visible = true;
            Label6.Visible = true;
        ...
        protected void btnCumplida_Click(object sender, EventArgs e)
        {
            ...
            gvNuc.DataBind();
            Label7.Text = gvNuc.Rows.Count.ToString();
            lblBuscar.Visible = false;
            ddlBuscar.Visible = false;
            btnMostrar.Visible = true;
            Label7.Visible = true;
        ...
        protected void btnConcluida_Click(object sender, EventArgs e)
        {
            ...
            gvNuc.DataBind();
            Label10.Text = gvNuc.Rows.Count.ToString();
            lblBuscar.Visible = false;
            ddlBuscar.Visible = false;
            btnMostrar.Visible = true;
        ...
        {
            if (Session["ID_SP_TEMP"].ToString() != "" && Session["ID_USUARIO_TEMP"].ToString() != "")
            {
                PGJ.EliminarSolicitudPTemporal(Convert.ToInt32(Session["ID_SP_TEMP"].ToString()), Convert.ToInt32(Session["ID_USUARIO_TEMP"].ToString()));
            }
