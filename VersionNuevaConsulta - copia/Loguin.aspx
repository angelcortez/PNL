<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Loguin.aspx.cs" Inherits="AtencionTemprana.Loguin" %>
...
<h2 align="Right">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td class="style2">
                <asp:TextBox ID="usuarioLog" runat="server" TabIndex="1"  style="text-transform :uppercase"></asp:TextBox>
&nbsp;</td>
            <td>
                &nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td class="style2">
                <asp:TextBox ID="passLog" runat="server" TextMode="Password" TabIndex="2" MaxLength="10" style="text-transform :uppercase"></asp:TextBox>
            </td>
            <td>
                <asp:Label ID="msjError" runat="server" Font-Bold="True" Font-Size="Small" 
        ...
        <tr>
            ...
            <td class="style2">
                <asp:Button ID="cmdAceptar"  runat="server" Text="ENTRAR" Font-Bold="true" 
                    onclick="clicEnter" Width="156px" TabIndex="3" Height="30px" class="button" />
            </td>
            <td>
                &nbsp;</td>
            <td>
