<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormaInicioRac.aspx.cs" Inherits="AtencionTemprana.FormaInicioRac" %>
                        ...
                        <table style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td class="style2">
                                    ...
                                    <asp:Button ID="cmdDenunciaAnonima" runat="server" CssClass="button" 
                                        Font-Bold="True" Font-Size="Small" Height="61px" 
                                        Text="DENUNCIA ANONIMA" Width="233px" onclick="cmdDenunciaAnonima_Click" />
