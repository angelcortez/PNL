<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InicioProcesoNoAceptacion.aspx.cs" Inherits="AtencionTemprana.InicioProcesoNoAceptacion" %>
            ...
            <tr>
                <td align="center" colspan="3">
                    ...
                    <asp:DropDownList ID="ddlBuscar" runat="server" AutoPostBack="True" 
                        ...
                        <asp:ListItem Value="7">REQUEIDO</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="gvMediacion" runat="server" BackColor="White" 
                        ...
                        onrowdatabound="gvMediacion_RowDataBound" DataKeyNames="ID_CARPETA" >
            ...
            <tr>
                <td>
                    <asp:SqlDataSource ID="dsConsultaSoliciudMediacion" runat="server" 
                        ...
                        SelectCommand="consultaInicioProcesoNoAceptacion" 
                    ...
                    <asp:SqlDataSource ID="dsBuscarRAC" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:PGJ_NSJPConnectionString2 %>" 
                        SelectCommand="buscarInicioProcesoNoAceptacionRac" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="dsBuscarFechaInicioRAC" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:PGJ_NSJPConnectionString2 %>" 
                        SelectCommand="buscarInicioProcesoNoAceptacionFechaInicioRac" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="lblIdUnidad" Name="IdUnidad" 
                                PropertyName="Text" Type="Int32" />
                    ...
                    <asp:SqlDataSource ID="dsBuscarNUM" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:PGJ_NSJPConnectionString2 %>" 
                        SelectCommand="buscarInicioProcesoNoAceptacionNUM" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="dsBuscarFechaInicioNUM" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:PGJ_NSJPConnectionString2 %>" 
                        SelectCommand="buscarInicioProcesoNoAceptacionFechaInicioNum" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="lblIdUnidad" Name="IdUnidad" 
                                PropertyName="Text" Type="Int32" />
                    ...
                    <asp:SqlDataSource ID="dsBuscarDenunciante" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:PGJ_NSJPConnectionString2 %>" 
                        SelectCommand="buscarInicioProcesoNoAceptacionDenunciante" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="dsBuscarNuc" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:PGJ_NSJPConnectionString2 %>" 
                        SelectCommand="buscarInicioProcesoNoAceptacionNUC" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="dsBuscarRequerido" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:PGJ_NSJPConnectionString2 %>" 
                        SelectCommand="buscarInicioProcesoNoAceptacionRequerido" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
