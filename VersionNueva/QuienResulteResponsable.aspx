<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuienResulteResponsable.aspx.cs" Inherits="AtencionTemprana.QuienResulteResponsable" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td>
                    ...
                    Text="QUIEN RESULTE RESPONSABLE" Font-Bold="True" Font-Size="Medium" 
        ...
        <tr>
            <td>
                    ...
                    ID="lblResulte" Visible="False"></asp:Label>
                                            ...
                                            <asp:Label runat="server" Text="RESPONSABLE" 
                    ID="lblResponsable" Visible="False"></asp:Label>
        ...
        <tr>
            <td>
                ...
                <asp:Label ID="IdTipoActor" runat="server" Text="3" Visible="False"></asp:Label>
            </td>
            <td>
