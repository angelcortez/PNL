<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="EliminarImagenesSolicitudPericiales.aspx.cs" Inherits="AtencionTemprana.EliminarImagenesSolicitudPericiales" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:ImageButton ID="IBOrden" runat="server" Height="18px" 
                     ...
                     <asp:Label ID="lblMisOrdenes" Text="CARGAR IMÁGEN" runat="server" 
                ...
                <asp:GridView ID="gvImagenes" runat="server" BackColor="White" 
                       ...
                       >
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                             <a href='EliminarImagenesSolicitudPericiales.aspx?ID_FOTO=<%#Eval("ID_FOTO_P")%>&op=Foto' >
                                 <asp:Image ID="Image2" runat="server" Height="28px" ImageUrl="img/foto.jpg" /></a>
                            </ItemTemplate>
                          </asp:TemplateField>

                            <asp:BoundField DataField="ID_FOTO_P" HeaderText="ID_FOTO" 
                                SortExpression="ID_FOTO_P" Visible="false" />
                            ...
                            <ItemTemplate>
                                     <asp:ImageButton ID="IBImage" runat="server" ImageUrl="img/eliminar.png" Height="28px" OnCommand="IBImage_Command"
                                          CommandArgument='<%# Eval("ID_FOTO_P") %>' />
                                 </ItemTemplate>
                          </asp:TemplateField>
            ...
            <tr>
                <td>
                     <asp:SqlDataSource ID="dsCargarImagenes" runat="server" 
                         ...
                         SelectCommand="CargarImagenesPericiales" SelectCommandType="StoredProcedure">
                         <SelectParameters>
