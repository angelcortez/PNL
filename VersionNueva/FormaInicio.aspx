<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormaInicio.aspx.cs" Inherits="AtencionTemprana.FormaInicio" %>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="cmdRazon" runat="server" Font-Bold="True" Font-Size="Small" 
                                        ForeColor="#006600" Height="61px" onclick="cmdRazon_Click" 
                                        Text="RAZON DE AVISO" Width="233px" />
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
                                    ...
                                    <tr>
                                        <td align="center" colspan="3">
                                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" 
                                                ForeColor="#006600" Text="INICIAR NUMERO DE ATENCION INMEDIATA"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style2">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <asp:ImageButton ID="ImgNo" runat="server" ImageUrl="~/img/no.png" 
                                                onclick="ImgNo_Click" TabIndex="5" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
