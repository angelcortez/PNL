<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgregarProfugoSec.aspx.cs" Inherits="AtencionTemprana.AgregarProfugoSec" %>
    ...
    <div id="main-wrapper">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td class="style7">
                    <asp:Label ID="ID_CARPETA" runat="server" ForeColor="Red" Visible="True"></asp:Label>
                </td>
                <td class="style7">
                    <asp:Label ID="ID_MUNICIPIO_CARPETA" runat="server" ForeColor="Red" Visible="True"></asp:Label>
                </td>
                
            </tr>
            <tr>
                <td colspan="4">
                    <asp:Panel ID="Panel3" runat="server" GroupingText="DATOS DEL PRÓFUGO" Font-Bold="True"
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>
                                    <asp:TextBox runat="server" MaxLength="30" TabIndex="4" Width="200px" ID="txtAlias"
