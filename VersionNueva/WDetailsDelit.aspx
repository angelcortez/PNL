<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WDetailsDelit.aspx.cs" Inherits="AtencionTemprana.WDetailsDelit" %>
   ...
   <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
     ...
     <asp:ObjectDataSource ID="ObjectTabla" runat="server" 
             ...
             TypeName="AtencionTemprana.dsReportesTableAdapters.SP_ConteoDelitosTablaTableAdapter">
                    <SelectParameters>
<asp:ControlParameter ControlID="IdUnidad" PropertyName="Text" Name="IdUnidad" Type="Int32"></asp:ControlParameter>
                        <asp:ControlParameter ControlID="FI" Name="Fecha1" PropertyName="Text" 
                            Type="String" />
                        <asp:ControlParameter ControlID="FF" Name="Fecha2" 
