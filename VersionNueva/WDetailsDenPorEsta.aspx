<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WDetailsDenPorEsta.aspx.cs" Inherits="AtencionTemprana.WDetailsDenPorEsta" %>
        ...
        TypeName="AtencionTemprana.dsReportesTableAdapters.ESTADISTICA_ESTADOSTableAdapter">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="FI" Name="fechainicio" PropertyName="Text" 
                            Type="String" />
                        <asp:ControlParameter ControlID="FF" Name="fechafin" 
