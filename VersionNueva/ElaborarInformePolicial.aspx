<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ElaborarInformePolicial.aspx.cs" Inherits="AtencionTemprana.ElaborarInformePolicial" %>
             ...
             <tr>
                <td>
                    ...
                    <asp:ImageButton ID="IBOrden" runat="server" Height="18px" 
                     ...
                     <asp:Label ID="Label5" Text="ANEXOS" runat="server" Font-Bold="True" Font-Size="18px" ForeColor="#666666" style="text-transform :uppercase" class="margen"></asp:Label>    
                </td>
                    <br />
                    <br />
                </td>
      ...
      <table style="width: 100%;" runat="server" id="tbl_informe">
            <tr>
                <td>
                    <br />
                    <br />
                     <asp:Label ID="Label1" runat="server" Text="INFORME DE LA INVESTIGACIÓN" Font-Bold="True" ></asp:Label>
                     <br />
                     <br />
                     <asp:TextBox ID="txtInforme" runat="server" Height="182px" TextMode="MultiLine" MaxLength="6000" style="text-transform :uppercase"
                         Width="728px"></asp:TextBox>
                     <br />
                     <br />
                    <asp:Button ID="cmdInforme" runat="server" Text="GUARDAR INFORME" 
