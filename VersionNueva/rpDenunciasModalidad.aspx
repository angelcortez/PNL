<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpDenunciasModalidad.aspx.cs" Inherits="AtencionTemprana.rpDenunciasModalidad" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <h2> 
        <asp:Label ID="lblOperacion" runat="server" 
            ForeColor="#006600">DELITOS CULPOSOS Y DOLOSOS</asp:Label></h2>
        ...
        <tr>
            <td colspan="3">
                ...
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                    ...
                    <LocalReport ReportPath="rpModalidad.rdlc">
                        <DataSources>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    ...
                    TypeName="AtencionTemprana.dsReportesTableAdapters.REPORTE_DELITOS_MODALIDADTableAdapter">
                    <SelectParameters>
