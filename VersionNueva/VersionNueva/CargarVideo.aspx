<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CargarVideo.aspx.cs" Inherits="AtencionTemprana.CargarVideo" %>
    ...
    <table style="width: 100%;">
            <tr>
                <td>
                    ...
                    <asp:ImageButton ID="IBEliminar" runat="server" Height="18px" 
                     ...
                     <asp:Label ID="Label5" Text="VÍDEOS" runat="server" Font-Bold="True" Font-Size="18px" ForeColor="#666666" style="text-transform :uppercase" class="margen"></asp:Label>    
            ...
            <tr>
                <td >
                    ...
                    <asp:TextBox ID="txtTitulo" runat="server" MaxLength="240"></asp:TextBox>
                    <br />
                    <br />
                    <asp:Label ID="Label2" runat="server" Text="DESCRIPCIÓN" class="margen" Font-Size="14"></asp:Label>
                    <asp:TextBox ID="txtDescripcion" runat="server" MaxLength="2300"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td> 
                     ...
                     <asp:GridView ID="gvVideos" runat="server" BackColor="White" 
                        ...
                        AutoGenerateColumns="False" DataSourceID="dsCargarVideoReciente" 
                        AllowPaging="True" 
                       >
            ...
            <tr>
                <td>
                     <asp:SqlDataSource ID="dsCargarVideoReciente" runat="server" 
                         ConnectionString="<%$ ConnectionStrings:PGJ_NSJPConnectionString2 %>" 
                         SelectCommand="CargarVideoRecientePI" SelectCommandType="StoredProcedure">
                         <SelectParameters>
