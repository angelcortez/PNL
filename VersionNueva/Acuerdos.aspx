<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Acuerdos.aspx.cs" Inherits="AtencionTemprana.Acuerdos" %>
...
<h2>&nbsp;</h2>
      ...
      <table style="width: 100%;">
            ...
            <tr>
                <td align="center" colspan="3">
                    ...
                    <asp:DropDownList ID="ddlBuscar" runat="server" AutoPostBack="True" 
                        ...
                        <asp:ListItem Value="2">FECHA INICIO NUM</asp:ListItem>
                        <asp:ListItem Value="3">SOLICITANTE</asp:ListItem>
                        <asp:ListItem Value="4">REQUEIDO</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left" colspan="3">
                    <asp:Label ID="UNDD0" runat="server" Font-Bold="True" Font-Size="Medium" 
                        ForeColor="#006600">ACUERDOS CUMPLIDOS</asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <asp:GridView ID="gvMediacion" runat="server" BackColor="White" 
                        ...
                        DataSourceID="dsConsultaSoliciudMediacion" DataKeyNames="ID_CARPETA" >
                        ...
                        <Columns>
                            ...
                            <a href='NUM_ACUERDOS.aspx?ID_CARPETA=<%#Eval("ID_CARPETA")%>&amp;ID_ESTADO_NUM=<%#Eval("ID_ESTADO_NUM")%>'>
                      ...
                      <asp:Image ID="Image1" runat="server" Height="40px" ImageUrl="img/view-tree.png" />
                            ...
                            <asp:BoundField DataField="FECHA_NUM" HeaderText="FECHA INICIO" 
                                SortExpression="FECHA_NUM" ReadOnly="True" />
                            <asp:BoundField DataField="ESTADO_CARPETA" HeaderText="ESTADO NUM" 
                            ...
                            <asp:BoundField DataField="ID_UNDD" HeaderText="ID_UNDD" 
                             ...
                             <asp:BoundField DataField="DENUNCIANTE" HeaderText="SOLICITANTE" 
                                 ReadOnly="True" SortExpression="DENUNCIANTE" />
                              
                            <asp:BoundField DataField="REQUERIDO" HeaderText="REQUERIDO" ReadOnly="True" 
                                SortExpression="REQUERIDO" />
            ...
            <tr>
                <td>
                    <asp:SqlDataSource ID="dsConsultaSoliciudMediacion" runat="server" 
                        ...
                        SelectCommand="consultaAreaSeguimiento" 
            ...
            <tr>
                <td colspan="3">
                    <asp:Label ID="UNDD1" runat="server" Font-Bold="True" Font-Size="Medium" 
                        ForeColor="#006600">ACUERDOS INCUMPLIDOS</asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <asp:GridView ID="gvMediacion0" runat="server" AllowPaging="True" 
                        AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                        BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                        DataKeyNames="ID_CARPETA" DataSourceID="dsConsultaSoliciudMediacion" 
                        ForeColor="Black" GridLines="Vertical" Width="1100px">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:TemplateField HeaderText=" ">
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="NUM" HeaderText="NUM" ReadOnly="True" 
                                SortExpression="NUM" />
                            <asp:BoundField DataField="FECHA_NUM" HeaderText="FECHA INICIO" ReadOnly="True" 
                                SortExpression="FECHA_NUM" />
                            <asp:BoundField DataField="ESTADO_CARPETA" HeaderText="ESTADO NUM" 
            ...
            <tr>
                <td>
                    <asp:Label ID="UNDD2" runat="server" Font-Bold="True" Font-Size="Medium" 
                        ForeColor="#006600">ACUERDOS SUSPENDIDOS POR REVISION</asp:Label>
                </td>
                <td>
                    &nbsp;</td>
                <td>
            ...
            <tr>
                <td>
                    <asp:GridView ID="gvMediacion1" runat="server" AllowPaging="True" 
                        AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                        BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                        DataKeyNames="ID_CARPETA" DataSourceID="dsConsultaSoliciudMediacion" 
                        ForeColor="Black" GridLines="Vertical" Width="1100px">
