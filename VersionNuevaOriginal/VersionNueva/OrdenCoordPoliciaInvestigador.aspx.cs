...
{
    public partial class OrdenCoorPoliciaInvestigador : System.Web.UI.Page
    {
        Data PGJ = new Data();
        ...
        protected void CargarDatosCarpeta()
        {
            try
            {
                ...
                //PGJ.InsertaArbol(20, 17, "VIDEOS", "", "", IdUser);
                ...
                CargarDatosArbol("PoliciaCoord", 17);
                CargarDatosArbol("FotoCoord", 18);
                CargarDatosArbol("AnexoCoord", 19);
                //CargarDatosArbol("Video", 20);
            ...
            {
                Response.Redirect("OrdenCoordPoliciaInvestigador.aspx");
