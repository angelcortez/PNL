...
{
    public partial class UnidadPNL : System.Web.UI.Page
    {
        Data PGJ = new Data();
        ...
        protected void cmdAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (ddlBuscar.SelectedValue == "3")
            {
                ...
                //BUSCA EN LAS REMITIDAS
                GridRemitidas.Visible = true;
                GridRemitidas.DataSourceID = "sqlDSRemitidas";
                GridRemitidas.DataBind();
            ...
            {
                gvNuc.DataSourceID = "dsBuscarOfendido";
                gvNuc.DataBind();
            }
        }
        ...
        protected void cmdNuc_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("WTipoDQNuc.aspx");
        ...
        protected void gvNuc_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                if (e.Row.Cells[6].Text == "TRAMITE")
                {
                    e.Row.ForeColor = System.Drawing.Color.Red;
                }
                if (e.Row.Cells[6].Text.IndexOf("JUDICIALIZADA") >= 0)
                {
                    e.Row.ForeColor = System.Drawing.Color.Blue;
                }
                if (e.Row.Cells[6].Text == "ARCHIVO TEMPORAL")
                {
                    e.Row.ForeColor = System.Drawing.Color.Black;
                }
                if (e.Row.Cells[6].Text == "NO EJERCICIO")
                {
                    e.Row.ForeColor = System.Drawing.Color.Brown;
                }
                if (e.Row.Cells[6].Text == "CRITERIO DE OPORTUNIDAD")
                {
                    e.Row.ForeColor = System.Drawing.Color.Green;
                }
                if (e.Row.Cells[6].Text == "ACUERDO PARA ABSTENERSE DE INVESTIGAR")
                {
                    e.Row.ForeColor = System.Drawing.Color.Violet;
                }
                if (e.Row.Cells[6].Text == "INCOMPETENCIA")
                {
